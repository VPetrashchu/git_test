...
-- Started on 2018-08-16 00:20:50 EEST
...
COPY public."Employee" (id, first_name, last_name, bearsday, hire_date, id_chief, notes) FROM stdin;
\.
...
COPY public."Order_product" (id_order, id_product, unit_price, count) FROM stdin;
\.
...
COPY public."Product" (id, name_product, price, id_producer, id_category) FROM stdin;
\.
...
-- Completed on 2018-08-16 00:20:50 EEST
